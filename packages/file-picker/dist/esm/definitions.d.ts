 ...
 * @since 0.5.3
 */
export declare type PickMediaResult = PickFilesResult;
/**
 * @since 0.5.3
 */
export declare type PickImagesOptions = PickMediaOptions;
/**
 * @since 0.5.3
 */
export declare type PickImagesResult = PickMediaResult;
/**
 * @since 0.5.3
 */
export declare type PickVideosOptions = PickMediaOptions;
/**
 * @since 0.5.3
 */
export declare type PickVideosResult = PickMediaResult;
/**
 * @since 6.1.0
 */
 ...
 * @since 6.1.0
 */
export declare type PermissionType = 'accessMediaLocation' | 'readExternalStorage';
